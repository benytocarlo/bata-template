...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
		...
		"image": {$link->getImageLink($product.link_rewrite, $product.id_image, 'home_'|cat:$cookie->img_name)|json_encode},
		"image_cart": {$link->getImageLink($product.link_rewrite, $product.id_image, 'medium_'|cat:$cookie->img_name)|json_encode},
