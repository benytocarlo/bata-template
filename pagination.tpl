...
{if isset($p) AND $p}
	...
	{/if}
	<!-- Pagination -->
	<div id="pagination{if isset($paginationId)}_{$paginationId}{/if}" class="pagination dib">
	    {if $nb_products > $products_per_page && $start!=$stop}
			...
			method="get">
				<div>
					...
					{/if}
	                <!-- <input type="submit" class="btn btn-default button exclusive-medium" value="{l s='Show all'}" /> -->
