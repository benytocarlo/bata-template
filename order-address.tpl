...
<div class="addresses clearfix">
	...
	{if !$opc}
		<div id="ordermsg" class="form-group">
			<label class="txt">{l s='If you would like to add a comment about your order, please write it in the field below.'}</label>
...
{if !$opc}
		<p class="cart_navigation clearfix">
			...
			<a href="{$link->getPageLink($back_order_page, true, NULL, "step=0{if $back}&back={$back}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button button-exclusive btn btn-default">
				&laquo; {l s='Continue Shopping'}
			</a>
			<input type="submit" name="processAddress" class="standard-checkout button btn btn-default button-medium" value="{l s='Proceed to checkout'} &raquo; " />
		</p>
	</form>
{else}
	</div> <!--  end opc_account -->
