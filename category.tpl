            	 ...
            	 {if $scenes}
                  ...
                  {else}
                    ...
                    <div class="content_scene_cat_bg" {if $category->id_image}{/if}>
                    	<!-- Added by xpectrum -->
                    	<img class="cat_image" src="{$link->getCatImageLink($category->link_rewrite, $category->id_image)|escape:'htmlall':'UTF-8'}" width="882" height="328" alt="{$category->name|escape:'html':'UTF-8'}" title="{$category->name|escape:'html':'UTF-8'}" />
                    	<!-- /Added by xpectrum -->
