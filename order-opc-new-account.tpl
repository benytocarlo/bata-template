		...
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
				...
				<p class="submit">
                    ...
                    <input type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-default button-medium" value="{l s='Login'}" />
				</p>
			</div>
		</fieldset>
	</form>
        	...
        	<div class="box">
                ...
                <div id="opc_account_choice" class="row">
                    <div class="col-xs-12 col-md-6">
                        ...
                        <p class="opc-button">
                            <input type="button" class="btn btn-default button button-medium exclusive" id="opc_guestCheckout" value="{l s='Guest checkout'}" />
                        </p>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <p class="opc-button">
                            <input type="button" class="btn btn-default button button-medium exclusive" id="opc_createAccount" value="{l s='Create an account'}" />
                        </p>
                    </div>
                </div>
				...
				<div class="submit opc-add-save clearfix">
                    ...
                    <input type="submit" name="submitAccount" id="submitAccount" class="btn btn-default button button-medium" value="{l s='Save'}" />
				</div>
