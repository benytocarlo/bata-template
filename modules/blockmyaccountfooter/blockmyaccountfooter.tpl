...
<div class="block myaccount">	
	<div class="block_content">
		<h4 class="title_block dropdown-cntrl dd_el_mobile">{l s='My account' mod='blockmyaccountfooter'}</h4>
		<ul class="bullet dropdown-content dd_container_mobile">
			...
			{else}
			<li><a href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Sign in' mod='blockmyaccountfooter'}" rel="nofollow">{l s='Sign in' mod='blockmyaccountfooter'}</a></li>
			{/if}
		</ul>
	</div>
</div>
