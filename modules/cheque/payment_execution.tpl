...
<form action="{$link->getModuleLink('cheque', 'validation', [], true)|escape:'html'}" method="post">
	...
	<p class="cart_navigation" id="cart_navigation">
		<input type="submit" value="{l s='I confirm my order' mod='cheque'} &raquo;" class="exclusive_large" />
		<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html'}" class="button_large">&laquo; {l s='Other payment methods' mod='cheque'}</a>
	</p>
</form>
{/if}
</div>
