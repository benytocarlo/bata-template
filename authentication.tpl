...
{/capture}
<div class="wht_bg">
	<div class="wrap_indent register-form">
			...
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
				...
				<div class="form_content clearfix">
					...
					<div class="form-group">
						...
						<input type="text" class="account_input form-control" data-validate="isEmail" id="email_create" name="email_create" value="{if isset($smarty.post.email_create)}{$smarty.post.email_create|stripslashes}{/if}" />
					</div>
					<div class="submit">
	...
	{if isset($inOrderProcess) && $inOrderProcess && $PS_GUEST_CHECKOUT_ENABLED}
		<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std clearfix">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<div class="required form-group">
						...
						<input type="text" class="form-control" data-validate="isEmail" id="guest_email" name="guest_email" value="{if isset($smarty.post.guest_email)}{$smarty.post.guest_email}{/if}" />
					</div>
					...
					<div class="required form-group">
						...
						<input type="text" class="form-control" data-validate="isName" id="firstname" name="firstname" onblur="$('#customer_firstname').val($(this).val());" value="{if isset($smarty.post.firstname)}{$smarty.post.firstname}{/if}" />
                    ...
                    <div class="required form-group">
                        ...
                        <input type="text" class="form-control" maxlength="12" id="rut" name="rut" value="{if isset($smarty.post.rut)}{$smarty.post.rut}{/if}" />
                    </div>
                    <div class="required form-group">
                        <label for="reg_phone">{l s='Teléfono'} <sup>*</sup></label>
                        <input type="text" class="form-control" maxlength="9" id="reg_phone" name="reg_phone" value="{if isset($smarty.post.reg_phone)}{$smarty.post.reg_phone}{/if}" />
                    </div>
					<div class="form-group date-select" style="margin-bottom: 30px;">
                    ...
                    <div class="checkbox">
                        ...
                        Acepto los <a href="{$link->getCMSLink('13', 'politica-de-privacidad')|escape:'html'}" title="{l s='terminos y condiciones'}">términos y condiciones</a></label>                        
                    </div>
			...
			<p class="cart_navigation required submit clearfix">
				<span><sup>*</sup>{l s='Required field'}</span><br/>
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			...
			<div class="required form-group">
				...
				<input onkeyup="$('#firstname').val(this.value);" type="text" class="form-control" data-validate="isName" id="customer_firstname" name="customer_firstname" value="{if isset($smarty.post.customer_firstname)}{$smarty.post.customer_firstname}{/if}" />
			</div>
			<div class="required form-group">
				<label for="customer_lastname">{l s='Last name'} <sup>*</sup></label>
				<input onkeyup="$('#lastname').val(this.value);" type="text" class="form-control" data-validate="isName" id="customer_lastname" name="customer_lastname" value="{if isset($smarty.post.customer_lastname)}{$smarty.post.customer_lastname}{/if}" />
			</div>
            <div class="required form-group">
				<label for="rut">{l s='Rut'} <sup>*</sup></label>
                <input type="text" class="form-control" maxlength="12" id="rut" name="rut" value="{if isset($smarty.post.rut)}{$smarty.post.rut}{/if}" />
			...
			<div class="required form-group">
				...
				<input type="text" class="form-control" data-validate="isEmail" id="email" name="email" value="{if isset($smarty.post.email)}{$smarty.post.email}{/if}" />
			</div>            
			<div class="required password form-group">
				<label for="passwd">{l s='Password'} <sup>*</sup></label>
				<input type="password" class="form-control" data-validate="isPasswd" name="passwd" id="passwd" />
				<span class="form_info">{l s='(Five characters minimum)'}</span>
			</div>
            <div class="required password form-group">
				<label for="conf_passwd">{l s='Confirmar contraseña'} <sup>*</sup></label>
				<input type="password" class="form-control" data-validate="isPasswd" name="conf_passwd" id="conf_passwd" />
			</div>
            <div class="required form-group">
				<label for="reg_phone">{l s='Teléfono'} <sup>*</sup></label>
                <input type="text" class="form-control" maxlength="9" id="reg_phone" name="reg_phone" value="{if isset($smarty.post.reg_phone)}{$smarty.post.reg_phone}{/if}" />
