...
{else}
	...
	<div class="block col-xs-12 col-sm-2" id="block_various_links_footer">
		...
		<h4 class="dd_el_mobile">{l s='¿Quiénes somos?' mod='blockcms'}</h4>
		<ul class="dd_container_mobile dropdown-content">
			...
			{/if}
            <li class="item">
                <a href="{$link->getPageLink('contact')|escape:'html':'UTF-8'}" title="{l s='Contáctanos' mod='blockcms'}">
                    {l s='Contáctanos' mod='blockcms'}
                </a>
            </li>
		</ul>
		{*$footer_text*}
