...
<div class="row addresses-lists">
	<div class="col-xs-12 col-sm-6 col-lg-4">
		<ul class="myaccount-link-list">
            ...
            {if $returnAllowed}
                <li><a href="{$link->getPageLink('order-follow', true)|escape:'html':'UTF-8'}" title="{l s='Merchandise returns'}"><i class="icon-refresh"><svg class="svgic svgic-return"><use xlink:href="#si-return"></use></svg></i><span>{l s='My merchandise returns'}</span></a></li>
            {/if}
